...
(() => {
var exports = {};
exports.id = "pages/api/testimonials/select";
exports.ids = ["pages/api/testimonials/select"];
exports.modules = {
...
/***/ "(api)/./pages/api/testimonials/select.js":
/*!******************************************!*\
  !*** ./pages/api/testimonials/select.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../config */ \"(api)/./config.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_config__WEBPACK_IMPORTED_MODULE_0__);\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{\n    let { Id } = req.body;\n    try {\n        await _config__WEBPACK_IMPORTED_MODULE_0__.sql.connect(_config__WEBPACK_IMPORTED_MODULE_0__.config);\n        let result;\n        if (Id !== 0) {\n            result = await _config__WEBPACK_IMPORTED_MODULE_0__.sql.query`Select * from TestimonialsMaster where Id=${Id}`;\n        } else {\n            result = await _config__WEBPACK_IMPORTED_MODULE_0__.sql.query`Select * from TestimonialsMaster`;\n        }\n        if (result.recordset.length !== 0) {\n            const testimonials = result.recordset;\n            res.status(200).json({\n                testimonials\n            });\n        } else {\n            res.status(401).json({\n                error: \"Testimonials list not found\"\n            });\n        }\n    } catch (error) {\n        console.error(\"Error executing query:\", error);\n        res.status(500).json({\n            error: error\n        });\n    } finally{\n        await _config__WEBPACK_IMPORTED_MODULE_0__.sql.close();\n    }\n});\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/testimonials/select.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/testimonials/select.js"));
