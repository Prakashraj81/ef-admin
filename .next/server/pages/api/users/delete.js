...
(() => {
var exports = {};
exports.id = "pages/api/users/delete";
exports.ids = ["pages/api/users/delete"];
exports.modules = {
...
/***/ "(api)/./pages/api/users/delete.js":
/*!***********************************!*\
  !*** ./pages/api/users/delete.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../config */ \"(api)/./config.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_config__WEBPACK_IMPORTED_MODULE_0__);\n// User delete api\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{\n    let { Id } = req.body;\n    if (Id !== 0) {\n        try {\n            await _config__WEBPACK_IMPORTED_MODULE_0__.sql.connect(_config__WEBPACK_IMPORTED_MODULE_0__.config);\n            await _config__WEBPACK_IMPORTED_MODULE_0__.sql.query`\r\n                UPDATE Authentication\r\n                SET Active=${2}, Modified_By=${\"Admin\"}\r\n                WHERE Id=${Id}`;\n            res.status(200).json({\n                message: \"User deleted successfully\"\n            });\n        } catch (error) {\n            console.error(\"Error updating:\", error);\n            res.status(500).json({\n                error: \"Internal server error\"\n            });\n        } finally{\n            await _config__WEBPACK_IMPORTED_MODULE_0__.sql.close();\n        }\n    } else {\n        res.status(400).json({\n            error: \"Invalid Id provided\"\n        });\n    }\n});\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/users/delete.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/users/delete.js"));
