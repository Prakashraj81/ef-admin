...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    try {
        ...
        let result = await _config__WEBPACK_IMPORTED_MODULE_0__.sql.query`Select count(Id) from EventMaster`;
...
var __webpack_exports__ = __webpack_require__.X(0, [19], () => (__webpack_exec__(2412)));
