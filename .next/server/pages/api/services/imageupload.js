...
const uploadDirectory = path__WEBPACK_IMPORTED_MODULE_2___default().join(process.cwd(), "public/services"); // This assumes the "uploads" directory is in the root of your project
...
var __webpack_exports__ = (__webpack_exec__(1483));
