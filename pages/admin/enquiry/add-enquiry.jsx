...
export default function AddEnquiryPage() {
  ...
  const InsertEnquiryForm = async()=> {
    ...
    else if(BusinessUnitInput === ""){
        isSumbitDisabled = true;
        setisSumbitDisabled(true);
    }
    else if(Address_1Input === ""){
        isSumbitDisabled = true;
        setisSumbitDisabled(true);
        setAddress_1Error(true);
    }     
    else if(JobLevelInput === ""){
        isSumbitDisabled = true;
        setisSumbitDisabled(true);
  ...
  return (
    ...
    {ShowLoader && (
      ...
      <DashboardCard title="Add enquiry"> 
        ...
        <Box>
            ...
            <div className="w-full inline-block">
                <div className="w-4/12 inline-block float-left px-2 mb-7">
                    ...
                    <select className='w-full p-3 custom-text-area' id="EnquiryType" variant="outlined" fullWidth>
            ...
            <div className="w-full inline-block">
                <div className="w-4/12 inline-block float-left px-2 mb-7">
                    ...
                    <select className='w-full p-3 custom-text-area' id="BusinessUnit" variant="outlined" fullWidth>
